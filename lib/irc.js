    ...
    self.addListener('raw', function(message) {
        ...
        switch (message.command) {
            ...
            case 'NOTICE':
                ...
                if (self.opt.debug && self.opt.logTypes.notice && to == self.nick)
                    util.log('GOT NOTICE from ' + (from ? '"' + from + '"' : 'the server') + ': "' + text + '"');
                break;
            case 'MODE':
                if (self.opt.debug && self.opt.logTypes.mode)
            ...
            case 'NICK':
                ...
                if (self.opt.debug && self.opt.logTypes.nick)
            ...
            case 'PRIVMSG':
                ...
                if (self.opt.debug && self.opt.logTypes.privmsg && to == self.nick)
            ...
            case 'INVITE':
                ...
                break;
            case 'QUIT':
                if (self.opt.debug && self.opt.logTypes.quit)
